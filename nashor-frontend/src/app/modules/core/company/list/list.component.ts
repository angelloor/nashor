...
export class CompanyListComponent implements OnInit {
    ...
    this.searchInputControl.valueChanges
      .pipe(
        ...
        switchMap((query) => {
           ...
           * Search
           */
          return this._companyService.queryRead(query.toLowerCase());
        })
      )
      .subscribe();
    /**
   ...
   * @param id_company
   */
  goToEntity(id_company: string): void {
    /**
     ...
     * Go to company
     */
    this._router.navigate([this.openMatDrawer ? '../' : './', id_company], {
      relativeTo: route,
    });
    /**
     * Mark for check
  ...
  createCompany(): void {
    this._angelConfirmationService
      .open({
        ...
        message:
          '¿Estás seguro de que deseas añadir una nueva empresa? ¡Esta acción no se puede deshacer!',
      })
      .afterClosed()
      .pipe(takeUntil(this._unsubscribeAll))
