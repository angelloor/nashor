...
@Component({
  selector: 'level-profile-list',
  templateUrl: './list.component.html',
})
export class LevelProfileListComponent implements OnInit {
  @ViewChild('matDrawer', { static: true }) matDrawer!: MatDrawer;
  count: number = 0;
  levelProfiles$!: Observable<LevelProfile[]>;
  ...
  selectedLevelProfile!: LevelProfile;
  ...
  ngOnInit(): void {
     ...
     */
    this.levelProfiles$ = this._levelProfileService.levelProfiles$;
    /**
     *  queryRead *
     */
    this._levelProfileService
      ...
      .subscribe((levelProfiles: LevelProfile[]) => {
         ...
         * Update the counts
         */
        this.count = levelProfiles.length;
        /**
         * Mark for check
         */
    ...
    this.searchInputControl.valueChanges
      .pipe(
        ...
        switchMap((query) => {
           ...
           * Search
           */
          return this._levelProfileService.queryRead(query.toLowerCase());
        })
      )
      .subscribe();
    /**
    ...
    this.matDrawer.openedChange
      ...
      .subscribe((opened) => {
        ...
        if (!opened) {
           ...
           */
          this.selectedLevelProfile = null!;
          /**
           * Mark for check
           */
          this._changeDetectorRef.markForCheck();
   ...
   */
  goToEntity(id_level_profile: string): void {
    /**
    ...
    this._router.navigate(
      [this.openMatDrawer ? '../' : './', id_level_profile],
      { relativeTo: route }
    );
    /**
     * Mark for check
   ...
   * createLevelProfile
   */
  createLevelProfile(): void {
    this._angelConfirmationService
      .open({
        title: 'Añadir perfil del nivel',
        message:
          '¿Estás seguro de que deseas añadir una nueva perfil del nivel? ¡Esta acción no se puede deshacer!',
      })
      .afterClosed()
      .pipe(takeUntil(this._unsubscribeAll))
              ...
              next: (_levelProfile: LevelProfile) => {
                ...
                if (_levelProfile) {
                  this._notificationService.success(
                    'Perfil del nivel agregada correctamente'
                  );
                  /**
                   * Go to new level_profile
                   */
                  this.goToEntity(_levelProfile.id_level_profile);
                } else {
