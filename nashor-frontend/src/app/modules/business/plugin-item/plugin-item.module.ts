...
import { ModalSelectPluginItemComponent } from './modal-select-plugin-item/modal-select-plugin-item.component';
import { PluginItemComponent } from './plugin-item.component';
import { pluginItemRoutes } from './plugin-item.routing';

@NgModule({
  declarations: [
    PluginItemListComponent,
    PluginItemDetailsComponent,
    PluginItemComponent,
    ModalSelectPluginItemComponent,
  ],
  imports: [
    RouterModule.forChild(pluginItemRoutes),
    MatButtonModule,
    MatCheckboxModule,
    MatDatepickerModule,
    MatDividerModule,
