...
import { levelStatusRoutes } from './level-status.routing';
import { LevelStatusListComponent } from './list/list.component';
import { ModalSelectLevelStatusComponent } from './modal-select-level-status/modal-select-level-status.component';

@NgModule({
  declarations: [
    LevelStatusListComponent,
    LevelStatusDetailsComponent,
    LevelStatusComponent,
    ModalSelectLevelStatusComponent,
  ],
  imports: [
    RouterModule.forChild(levelStatusRoutes),
    MatButtonModule,
    MatCheckboxModule,
    MatDatepickerModule,
    MatDividerModule,
