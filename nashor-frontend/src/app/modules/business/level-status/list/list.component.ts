...
@Component({
  selector: 'level-status-list',
  templateUrl: './list.component.html',
})
export class LevelStatusListComponent implements OnInit {
  ...
  selectedLevelStatus!: LevelStatus;
  ...
  ngOnInit(): void {
    ...
    this._levelStatusService
      ...
      .subscribe((levelStatuss: LevelStatus[]) => {
         ...
         * Update the counts
         */
        this.count = levelStatuss.length;
        /**
         * Mark for check
         */
   ...
   */
  goToEntity(id_level_status: string): void {
    /**
    ...
    this._router.navigate(
      [this.openMatDrawer ? '../' : './', id_level_status],
      { relativeTo: route }
    );
    /**
     * Mark for check
   ...
   * createLevelStatus
   */
  createLevelStatus(): void {
    this._angelConfirmationService
      .open({
        title: 'Añadir estado del nivel',
        message:
          '¿Estás seguro de que deseas añadir una nueva estado del nivel? ¡Esta acción no se puede deshacer!',
      })
      .afterClosed()
      .pipe(takeUntil(this._unsubscribeAll))
            ...
            .subscribe({
              next: (_levelStatus: LevelStatus) => {
                ...
                if (_levelStatus) {
                  ...
                  /**
                   * Go to new level_status
                   */
                  this.goToEntity(_levelStatus.id_level_status);
                } else {
