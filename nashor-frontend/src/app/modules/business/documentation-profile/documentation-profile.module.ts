...
import { ModalSelectDocumentationProfileComponent } from './modal-select-documentation-profile/modal-select-documentation-profile.component';

@NgModule({
  declarations: [
    DocumentationProfileListComponent,
...
export class DocumentationProfileModule {}
