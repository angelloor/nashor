...
@Component({
  selector: 'documentation-profile-list',
  templateUrl: './list.component.html',
})
export class DocumentationProfileListComponent implements OnInit {
  ...
  selectedDocumentationProfile!: DocumentationProfile;
  ...
  ngOnInit(): void {
    ...
    this._documentationProfileService
      ...
      .subscribe((documentationProfiles: DocumentationProfile[]) => {
         ...
         * Update the counts
         */
        this.count = documentationProfiles.length;
        /**
         * Mark for check
         */
    ...
    this.matDrawer.openedChange
      ...
      .subscribe((opened) => {
        ...
        if (!opened) {
           ...
           */
          this.selectedDocumentationProfile = null!;
          /**
           * Mark for check
           */
          this._changeDetectorRef.markForCheck();
    ...
    merge(
      ...
      .subscribe((keyUpOrKeyDown) => {
        ...
        if (
          ...
          this.createDocumentationProfile();
        }
      });
    /**
     * Shortcuts
  ...
  /**
   * Go to documentation_profile
   * @param id_documentation_profile
   */
  goToEntity(id_documentation_profile: string): void {
    /**
    ...
    this._router.navigate(
      [this.openMatDrawer ? '../' : './', id_documentation_profile],
      { relativeTo: route }
    );
    /**
     * Mark for check
   ...
   */
  createDocumentationProfile(): void {
    this._angelConfirmationService
      .open({
        title: 'Añadir perfil de documentación',
        message:
          '¿Estás seguro de que deseas añadir una nueva perfil de documentación? ¡Esta acción no se puede deshacer!',
      })
      .afterClosed()
      .pipe(takeUntil(this._unsubscribeAll))
      .subscribe((confirm: ActionAngelConfirmation) => {
        if (confirm === 'confirmed') {
          ...
          /**
           * Create the documentation_profile
           */
          this._documentationProfileService
            ...
            .subscribe({
              next: (_documentationProfile: DocumentationProfile) => {
                if (_documentationProfile) {
                  ...
                  /**
                   * Go to new documentation_profile
                   */
                  this.goToEntity(
                    _documentationProfile.id_documentation_profile
                  );
                } else {
