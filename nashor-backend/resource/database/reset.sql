...
select * from business.dml_control_create(1, 1, 'textArea', 'Para que quiere los materiales', 'motivo', '', true, 1, 150, 'Ingrese el motivo', true, '[]', true, false, 1);
select * from business.dml_control_create(1, 1, 'textArea', 'Tienes que justificar', 'justificacion', '', true, 1, 150, 'Ingrese la justificacion', true, '[]', true, false, 1);
select * from business.dml_control_create(1, 1, 'input', 'Ingrese la respuesta', 'respuesta', '', false, 1, 150, 'Ingrese la respuesta', true, '[]', true, false, 1);
select * from business.dml_control_create(1, 1, 'input', 'Ingrese la confirmacion', 'confirmacion', '', false, 1, 150, 'Ingrese la confirmacion', true, '[]', true, false, 1);
select * from business.dml_control_create(1, 1, 'textArea', 'Ingrese la aprobacion', 'aprobacion', '', false, 1, 150, 'Ingrese la aprobacion', true, '[]', true, false, 1);
...
select * from business.dml_flow_version_level_create(1, 1, 1, 1, 0, 'level', '0', '==', '', false, 50, 100);
select * from business.dml_flow_version_level_create(1, 1, 2, 2, 1, 'level', '0', '==', '', false, 350, 100);
select * from business.dml_flow_version_level_create(1, 1, 3, 3, 2, 'level', '0', '==', '', false, 650, 100);
select * from business.dml_flow_version_level_create(1, 1, 4, 5, 4, 'level', '0', '==', '', true, 400, 400);
select * from business.dml_flow_version_level_create(1, 1, 5, 6, 4, 'level', '0', '==', '', false, 900, 400);
select * from business.dml_flow_version_level_create(1, 1, 3, 4, 3, 'conditional', '3' , '==', '1', false, 650, 250);
...
select * from business.dml_level_profile_official_create(1, 2, 1, false);
select * from business.dml_level_profile_official_create(1, 3, 4, false);
select * from business.dml_level_profile_official_create(1, 3, 1, false);
